...
class InfoViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        let constraints = [
            ...
            headerLabel.leadingAnchor.constraint(equalTo: infoView.leadingAnchor, constant: 16),
            headerLabel.trailingAnchor.constraint(equalTo: infoView.trailingAnchor, constant: -141),
            
            advicesStack.topAnchor.constraint(equalTo: headerLabel.bottomAnchor, constant: 16),
            advicesStack.leadingAnchor.constraint(equalTo: infoView.leadingAnchor, constant: 16),
            advicesStack.trailingAnchor.constraint(equalTo: infoView.trailingAnchor, constant: -16),
            advicesStack.bottomAnchor.constraint(equalTo: scrollView.bottomAnchor)
        ]
